...
<body>
                            ...
                            <div class="row-left-header" style="display: flex; align-items: center;">
                                <div class="profile">
                                    ...
                                    <?php if ($user['UserLevel'] == 1) { ?>
                                        <img src="image/profile-img/<?= $user['image'] . ".png" ?>">
                                    <?php } elseif ($user['UserLevel'] == 2) { ?>
                                        <img src="uploader/img-profile-writer/<?= $user['image']; ?> " alt="">
                                    <?php } elseif ($user['UserLevel'] == 3) { ?>
                                        <img src="uploader/img-profile-writer/<?= $user['image']; ?> " alt="">
                                    <?php } elseif ($user['UserLevel'] == 4) { ?>
                                        <img src="uploader/img-profile-writer/4175unnamed.jpg">
                                    <?php } ?>
                                    <p>
                                    ...
                                    <div class="box-profile">
                                        ...
                                        <div class="profile-item">
                                            ...
                                            <h6>
                                                <a href="page/loginAdmin.php" style="color: #ffffff; text-decoration: none;"><?php if ($_SESSION['level'] == 3) {
                                                                                                                                    echo "پنل نویسندگان";
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="row-left-header">
                                            <span>
                                                <span><a href="page/register.php" style="color: #ffffff; text-decoration: none; font-size: 20px;">ثبت
    ...
    <div class="navigation">
        ...
        <hr style="border: 0; border-top: 1px solid rgba(0,0,0,.1); margin-top: 0; margin-bottom: 1rem;">
                    ...
                    <?php foreach ($menus as $li) { ?>
                        <?php if ($menu['Id'] == $li['Z']) { ?>
                            <?php if ($menu['Id'] == $li['Z']) { ?>
                                ...
                                <div class="li-nav">
                                    <a href="<?= $li['Src']; ?>" style="text-decoration: none;">

                                        <p><span> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
    ...
    <div class="slider-down ">
        <div class="img-background ">
            <div class="container ">
                <div class="row">
                    <div class="to-slider" style="display: flex; align-items: baseline;">
                        <div class="stive-img">
                            <img src="image/steve-jobs-removebg-preview (1).png">
                        </div>
                        <div class="titre-img-slider">
                            <h1>
                                استیو جابز : من فکر می‌کنم وقتی شما کاری انجام می‌دهید و نتیجه‌ی خوبی حاصل می‌شود نباید بیش از
                                حد بر روام کاری شگفت‌انگیز بروید. فقط مرحله‌ی بعدی را پیدا کنید. رو به جلو حرکت کنید و هرگز دست
                                از پیشرفت و ترقی برندارید
                            </h1>
                        </div>
                    </div>
                </div>
        ...
        <div class="container ">
            <div class="row ">
                    ...
                    <?php foreach ($blogs as $blog) { ?>
                        <div class="box-blog">
                            <div class="img-box-blog">
                                <a href="page/blog.php?id=<?= $blog['id']; ?>" class="up-img-blog-box" style="text-decoration: none;">
                                    <button> ادامه
                                        <span></span>
                                    </button>
                                    <style>
                                ...
                                <a href=""><img src="uploader/upload-image-blog/<?= $blog['image'] ?>" alt=""></a>
                            </div>
                            <div class="titre-blog-box">
                                <a href="page/blog.php?id=<?= $blog['id']; ?>" style="text-decoration: none; color: rgb(62, 62, 62);">
                                    <p style="margin-top: 10px; font-size: 20px; margin-bottom: 30px;">
                                        <?= " . . . " . $blog['title']  ?></p>
                                </a>
                            </div>
                ...
                margin-left: 1px;" class="bi bi-person" viewBox="0 0 16 16">
                                    ...
                                    <p><?php foreach ($writers as $writer) {
                                            if ($blog['writer'] == $writer['id']) {
